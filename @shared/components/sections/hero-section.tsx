...
import { LiquidCtaButton } from "@shared/components/buttons/liquid-cta-button"
...
export function HeroSection() {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-20 relative">
      ...
      <video src="/Untitled%201-1.mp4" className="absolute z-0 inset-0 w-full h-full object-cover opacity-50" autoPlay muted></video>
      {/* <div className="absolute inset-0 bg-gradient-to-b z-[1] from-zinc-900/50 via-transparent to-transparent" /> */}
